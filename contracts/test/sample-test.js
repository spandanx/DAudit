...
describe("create bill", () => {
  ...
  it("Check encashment accept", async()=>{
    ...
    await voteManager.approveRequestMerge(mergeBillOwnAddress, rootDepartmentAddress, rootDepartmentAddress, action.ACCEPT, tokenAddress, "Merge request accepted");
